...
public class SuggestionsManager {
	...
	public ArrayList<Listing> rankSuggestions(Seeker seeker){
		...
		try {
			for(Listing listing:listings){
				...
				workExScore = this.getWorkExperienceScore(seeker, listing);
	...
	public ArrayList<Seeker> rankSuggestions(Listing listing){
		...
		try {
			for(Seeker seeker:seekers){
				...
				workExScore = this.getWorkExperienceScore(listing, seeker);
	...
	public int getSkillsScore(Listing listing){
	 ...
	 public int scoreSkills(String uoString, String utString){
	    ...
	    private double generateSkillScore(String skill, String[] skillList){
	        int score = 0;
